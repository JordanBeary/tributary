...
*2026-08-20. Category: analytics-layer architecture (design Sections 7.3 and 9, Phase 4 row). Proposed by the agent under the human's standing P-009 preference; **ratification requested** (see the Phase 4 handoff for the concrete ask).*
